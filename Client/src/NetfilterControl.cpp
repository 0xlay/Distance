...
NetfilterControl::NetfilterControl(const char* path)
...
NetfilterControl::~NetfilterControl()
{
    UnInitWfp();
...
void NetfilterControl::UnInitWfp()
{
    if (Engine_ == NULL)
        return;
