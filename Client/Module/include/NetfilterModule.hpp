#ifndef _DISTANCE_NETFILTER_MODULE_HPP_
#define _DISTANCE_NETFILTER_MODULE_HPP_
...
namespace Distance
{
    class NetfilterModule : public IModule
    {
    public:
        NetfilterModule(const char* path);
        ~NetfilterModule();
...
#endif // _DISTANCE_NETFILTER_MODULE_HPP_